export const en = {
  ...
  upgrade: {
    ...
    coachLocked: 'The AI coach is part of Calgym Pro.',
    equipmentLocked: 'Gym equipment scanning is part of Calgym Pro.',
    tierFree: 'Free',
    tierPro: 'Pro',
    tierProPlus: 'Pro+',
    tierFreeDesc: '10 AI actions/month · manual logging, barcode, library, schedule',
    tierProDesc: '150 AI actions/month · AI coach · equipment scan',
    tierProPlusDesc: '500 AI actions/month · highest accuracy · everything in Pro',
  ...
  coach: {
    ...
    lockedTitle: 'Unlock the AI coach',
    lockedBody: 'Ask about your own meals, macros and training — included with Pro.',
    mockReply:
